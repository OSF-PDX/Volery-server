...
7. Once you log in, you will be redirected back to http://localhost:3001. From here, you can click the "View Accounts" link to confirm that you are able to make an API call.
